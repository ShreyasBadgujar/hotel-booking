...
const HotelCard = ({room,index}) => {
    ...
    return (
        <Link to={'/rooms/' + room._id} onClick={() => scrollTo(0, 0)} key={room._id} className='relative w-72 rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
            <img src={room.images[0]} alt="hotel-img" draggable="false" className='w-full h-44 object-cover' />
            ...
            <div className='p-4 pt-5'>
                ...
                <div className='flex items-center justify-between mt-4'>
                    <p><span className='text-xl text-gray-800'>{formatPrice(room.pricePerNight)}</span>/night</p>
